...
PRIORITY_SCRIPTS=("replace_fs.sh" "wifi_executor.sh" "setup_harrogate.sh" "comm_executor.sh" "base_executor.sh" "bias_creater.sh" "camera_executor.sh" "fake_client_executor.sh" "fake_server_executor.sh" "bias_executor.sh")
