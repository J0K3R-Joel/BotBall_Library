...
# Date: 2025-07-27
# Purpose: Create the base user with all needed files and libraries

# ==== Configuration ====
USER_NAME="Base"
PROJECT_NAME="actual"
USB_MOUNT="/media/kipr"
DEST_BASE="/home/kipr/Documents/KISS"
USERS_FILE="/home/kipr/Documents/KISS/users.json"
SRC_COMM_FOLDER_NAME="src_Base"

# ==== Find the USB-project folder ====
