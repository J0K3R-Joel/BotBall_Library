...
# Date: 2025-09-24
# Purpose: Create the bias calibration
...
# ==== Paste src_BIAS in bin/ and src/ (relativ) ====
USB_SRC_BIAS="$SRC_DIR/$SRC_BIAS_FOLDER_NAME"

if [ ! -d "$USB_SRC_BIAS" ]; then
    echo "=========='$SRC_BIAS_FOLDER_NAME' folder not found relative to script!=========="
    exit 1
fi
...
# ==== Ending message ====
echo ""
echo "BIAS User-script finished."