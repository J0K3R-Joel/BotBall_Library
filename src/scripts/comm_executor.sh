...
# Date: 2025-07-27
# Purpose: Create the communication between the two wallabies

# ==== Configuration ====
USER_NAME="RoboCommunication"
PROJECT_NAME="setup"
DEST_BASE="/home/kipr/Documents/KISS"
USERS_FILE="/home/kipr/Documents/KISS/users.json"
SRC_COMM_FOLDER_NAME="src_COMM"
...
# ==== Paste src_COMM in bin/ and src/ (relativ) ====
USB_SRC_COMM="$SRC_DIR/$SRC_COMM_FOLDER_NAME"

if [ ! -d "$USB_SRC_COMM" ]; then
    echo "=========='$SRC_COMM_FOLDER_NAME' folder not found relative to script!=========="
    exit 1
fi
...
echo "src_COMM files copied to bin/ and src/."
