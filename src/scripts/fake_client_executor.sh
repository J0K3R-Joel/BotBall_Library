...
# Date: 2025-09-16
# Purpose: Create the client for the communication

# ==== Configuration ====
USER_NAME="Fake-Client"
PROJECT_NAME="setup"
DEST_BASE="/home/kipr/Documents/KISS"
USERS_FILE="/home/kipr/Documents/KISS/users.json"
SRC_FAKE_CLIENT_FOLDER_NAME="src_Fake-Client"
...
# ==== Paste src_Fake-Client in bin/ and src/ (relativ) ====
USB_SRC_FAKE_CLIENT="$SRC_DIR/$SRC_FAKE_CLIENT_FOLDER_NAME"

if [ ! -d "$USB_SRC_FAKE_CLIENT" ]; then
    echo "=========='$SRC_FAKE_CLIENT_FOLDER_NAME' folder not found relative to script!=========="
    exit 1
fi
...
# ==== Ending message ====
echo ""
echo "Fake_Client-script finished."